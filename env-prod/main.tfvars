parameters = [
  { name = "prod.frontend.catalogue_url", value = "http://catalogue-prod.rdevopsb72.online:80/" },
  { name = "prod.frontend.cart_url", value = "http://cart-prod.rdevopsb72.online:80/" },
  { name = "prod.frontend.user_url", value = "http://user-prod.rdevopsb72.online:80/" },
  { name = "prod.frontend.shipping_url", value = "http://shipping-prod.rdevopsb72.online:80/" },
  { name = "prod.frontend.payment_url", value = "http://payment-prod.rdevopsb72.online:80/" },
  { name = "prod.catalogue.mongo_endpoint", value = "mongodb-prod.rdevopsb72.online" },
  ...
  { name = "prod.user.mongo_endpoint", value = "mongodb-prod.rdevopsb72.online" },
  ...
  { name = "prod.payment.amqp_host", value = "rabbitmq-prod.rdevopsb72.online" },
